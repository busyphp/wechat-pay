 ...
 * @version $Id: 2020/7/8 下午7:31 下午 WeChatNativePayNotify.php $
 * @see https://pay.weixin.qq.com/wiki/doc/api/native.php?chapter=9_7&index=8
 */
class WeChatNativePayNotify extends WeChatPay implements PayNotify
{
    ...
    public function notify()
    {
        ...
        $queryOrder = new WeChatNativePayQueryOrder();
